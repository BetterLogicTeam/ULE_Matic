      ...
      <ToastContainer />
       {/* <Header /> */}
        ...
        <Route/>
          ...
          <Route exact path="/Register_with_Matic" element={<Register_main notify={notify} />} />
          <Route exact path="/Registration_with_BNB" element={<Registration_with_BNB notify={notify} />} />
