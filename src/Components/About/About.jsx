            ...
            <div class="row g-5 align-items-center flex-md-row-reverse">
                ...
                <div class="col-lg-6">
                   <div class="banner-content">
                        ...
                        <p>UleMaticx network is the premier marketplace for UleMaticx, which are digital items you can truly own. Digital Items have existed for a long time, but never like this can be farm.
                        </p>
