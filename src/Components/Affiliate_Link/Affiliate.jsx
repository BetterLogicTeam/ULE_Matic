    ...
    return (
        <>
            <div className="Earned_USD bg-color p-0 mt-3 br-1">
                <div className=" p-3 row" style={{height: "90px"}}>
                    <p className="p-color">{props.data.text}</p>
                    {/* <h1 className="h-color h3">{props.data.earned_usd}</h1> */}
                    <div className='main_div_Affiliate' style={{ marginTop: "-10px"}}>

                        <input class=" text-white bg-color inputAffiliate" type="text" style={{ height: "30px"}} value={props.data.earned_usd} />
                        <CopyToClipboard text={props.data.earned_usd}
                            onCopy={() => setcopyTest(true)}  >
                            <div className='main_class_copy' style={{ marginTop: "-13px"}}>
