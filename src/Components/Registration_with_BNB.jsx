          ...
          <div className="main_form p-5">
            ...
            <div className="batan">
              ...
              <div className=" w-100 h-100 d-none justify-content-center align-items-center  position-absolute  modelRegister">
                <div className=" bg-white bord bord1 border-dark py-3 px-5 flex-column justify-content-center align-items-center d-flex">
                ...
                <div
                  className=" bg-white bordd bord1 border-dark py-3 px-5 flex-column justify-content-center align-items-center d-none"
                  style={{ marginLeft: '-4%' }}
                >
