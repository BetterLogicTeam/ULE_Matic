...
import Forum_Reward from '../../Routes/All_Income/Forum_Reward';
const Navbar = () => {
    ...
    return (
        <div className='row justify-content-center'>
            <div className='col-md-11'>
                <nav class="navbar navbar-expand-lg navbar-light row d-flex flex-column">
                    <div className='row justify-content-between brand-bar m-0 p-0'>
                        <img src='/ule_maticogo.png' className='navbar-brand col-lg-1 col-md-2 col-5' />
                    ...
                    <div class="collapse navbar-collapse row px-5 py-1" id="navbarNavDropdown">
                        <ul class="navbar-nav">
                            ...
                            <li>
                                <div>
                                    <button className='btn1 nav-btn-expand '> <BiLineChart className="me-1 mb-1 " /> All Reward</button>
                                    <div className='expand-nav  d-none flex-column'>
                                        {/* <Link to="/Dashboard/Referral_Income"><BsArrowRightShort /> Referral Income</Link> */}
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Registration_Direct_Income"><BsArrowRightShort /> Registration Direct Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Registration_Roi_Income"><BsArrowRightShort /> Registration Quarterly Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Roi_Income"><BsArrowRightShort />Daily Yield Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Activation_Direct_Income"><BsArrowRightShort /> Direct Referral Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Matching_Income"><BsArrowRightShort /> Augmented Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Forum_Reward"><BsArrowRightShort /> Forum Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Pool_income"><BsArrowRightShort /> Auto Club Reward</Link>
                            ...
                            <li>
                                <div>
                                    ...
                                    <div className='expand-nav  d-none flex-column'>
                                        ...
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/My_Team"><BsArrowRightShort /> My Forum</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Matching_Tree"><BsArrowRightShort /> Forum View</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Matics_tree"><BsArrowRightShort /> Club View</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Matics_Downline"><BsArrowRightShort />Club Downline</Link>


                                        {/* <Link onClick={()=>{onClickHide()}} to="/Dashboard/Level_Details"><BsArrowRightShort /> Level Details</Link>  */}
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Direct_Leg_Business"><BsArrowRightShort /> Forum Direct</Link>
                                    </div>
                                </div>
                            </li>
                            <li>
                    ...
                    <div className='nav-panel d-none  col-10'>
                        <ul class="row p-0 justify-content-center list-unstyled">
                            ...
                            <li class="col-xl-10 col-12 border_bottom">
                                <div>
                                    <button className='btn1 nav-btn-expand col-12 text-start fs-6 py-2'> <BiLineChart className="me-1 mb-1" /> All Reward</button>
                                    <div className='expand-nav-sm  d-none flex-column'>
                                    <Link onClick={()=>{onClickHide()}} to="/Dashboard/Registration_Direct_Income"><BsArrowRightShort /> Registration Direct Reward</Link>
                                        <Link onClick={()=>{onClickHide()}} to="/Dashboard/Activation_Direct_Income"><BsArrowRightShort /> Direct Referral Reward</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Matching_Income"><BsArrowRightShort /> Augmented Reward</Link>
                                        {/* <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Referral_Income"><BsArrowRightShort /> Referral Income</Link> */}
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Forum_Reward"><BsArrowRightShort />Forum Reward</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Roi_Income"><BsArrowRightShort />Daily Yield Reward</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Registration_Roi_Income"><BsArrowRightShort /> Registration Quarterly Reward</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Pool_income"><BsArrowRightShort />Auto Club Reward</Link>
                            ...
                            <li class="col-xl-10 col-12 border_bottom">
                                <div>
                                    ...
                                    <div className='expand-nav-sm  d-none flex-column'>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/My_Referral"><BsArrowRightShort /> My Referal</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Matching_Income"><BsArrowRightShort /> My Forum</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Matching_Tree"><BsArrowRightShort /> Forum View</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Matics_tree"><BsArrowRightShort /> Club View</Link>
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Matics_Downline"><BsArrowRightShort /> Club Downline</Link>


                                        {/* <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Level_Details"><BsArrowRightShort /> Level Details</Link> */}
                                        <Link onClick={()=>{onClickHideSM()}} to="/Dashboard/Direct_Leg_Business"><BsArrowRightShort /> Forum Direct</Link>
                                    </div>
                                </div>
                            </li>
                            <li class="col-xl-10 col-12 border_bottom">
            ...
            <Route path='/dashboard/Forum_Reward' element={<Forum_Reward />} />
