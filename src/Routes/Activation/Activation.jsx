    ...
    return (
        <>
            {isLoading ? (
                ...
                <div className="col-md-6 activation-bg">
                    <div className="ule_logo" style={{ margin: "8px 41%" }}>
                        {/* <img style={{height: "30px"}} src={logo1} /> */}
                    </div>
                    <div className="row">
                        <div className="col-12">
                            <h4 className="text-center upgradtext" >Upgrade</h4>
                        </div>
                    </div>
                    <div
                        className="modal-header upper-content"
                       
                    >
                        <br></br>
                        <div className="row">
                            <div className="col-lg-3"></div>
                            <div className="col-lg-4 act-width avlbal row" style={{ padding: "10px 20px 0 20px" }}>
                                <div className="input_and_text">
                                    <h6
                                        className="modal-title head col-12 pb-4"
                                ...
                                <div className="input_and_text">
                                    ...
                                    <h6
                                        className="modal-title col-12 head pb-4"
                                        id="exampleModal3Label2"
                                        style={{ color: "white" }}
                                    >
                                    ...
                                    <input
                                        ...
                                        id="txtchangevalue"
                                        style={{ borderRadius: '10px', height: '30px' }}
                                        value={` ${betaWallet?.activatupgradeamnt_trading} `}
                                        readonly=""
                                    />
                                ...
                                <div className="input_and_text">
                                    ...
                                    <h6 className="modal-title head col-12 pb-4" style={{ color: "white" }}
                                    ...
                                    <input
                                        ...
                                        id="txtchangevalue"
                                        style={{ borderRadius: '10px', height: '30px' }}
                                        value={` ${ratematic} Matic` + "/" + ` ${rate} USD`}
                                        readonly=""
                                    />
                            ...
                            <div className="addNum">
                                <div className="trxnumber">
                                    <div className="row rrp" >
                                        ...
                                        <div
                                            className="col-12 col-md-6 col-xl-10 p-3"
                                            style={{
                                                display: "flex",
                                                alignItems: "flex-end",
                                                // marginLeft: '11%'
                                            ...
                                            {apiDate && (
                                                <>
                                                    {isLoadingTrans ? (
                                                        ...
                                                        <button
                                                            className="lg-btn upgrade-btn-act"
                ...
                <div className="col-md-6 activation-bg" >
                    ...
                    <div className="row">
                        <div className="col-12">
                            <h4 className="text-center upgradtext" >Activation</h4>
                        </div>
                    </div>
                    <div
                        className="modal-header upper-content"
                    >
                        <br></br>
                        <div className="colo-g-4 avlbal row " style={{ padding: "10px 20px 0 20px" }}>
                        <div className="input_and_text">
                                    <h6
                                        className="modal-title act-inpt head col-12 pb-4"
                                        id="exampleModal3Label2"
                                        style={{ color: "white" }}
                                    >
                                        Available ULE Token Balance :
                                    ...
                                    <input
                                        type="text"
                                        className="input_width act-avlbal"
                                        id="txtchangevalue"
                                        style={{ borderRadius: '10px', height: '30px' }}
                                        // placeholder={`${balanceUle} Token`}
                                        value={` ${balanceUle} Token`}
                                ...
                                <div className="input_and_text">
                                    ...
                                    <h6
                                        className="modal-title col-12 act-inpt head pb-4"
                                        id="exampleModal3Label2"
                                        style={{ color: "white" }}
                                    >
                                        Previous Package amount :
                                ...
                                <div className="input_and_text">
                                    ...
                                    <h6 className="modal-title head act-inpt col-12 pb-4" style={{ color: "white" }}
                                        ...
                                        <div className="col-12 col-md-12 -col-xl-8 p-3" >
                                            ...
                                            <div className="row mt-3">
                                                <input
                                                    ...
                                                    className="form5 btm act-from"
                                                    min="100"
                                                    placeholder={(`${amount}` * `${rate}` + " " + "ULE")}
                                                />
                                            </div>
                                        </div>
                                        <div className="btn_here"></div>
                                        <div
                                            className="col-12 col-md-6 col-xl-4 p-3 act-btn-1 "
                                            style={{
                                                display: "flex",
                                                alignItems: "flex-end",
                                                // marginLeft: '11%'
                                            ...
                                            {apiDate && (
                                                <>
                                                    {isLoadingTrans ? (
                                                        ...
                                                        <button
                                                            className="lg-btn upgrade-btn-act act-bb-btn"
