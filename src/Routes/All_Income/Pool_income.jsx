    ...
    return ( 
        <div className="row justify-content-center">
            <div className="col-md-11 py-3">
                <PagePath data={{page_name:"Auto Club Reward",page_path:"All Reward / Auto Club Reward"}} />
                <div className=" row mx-0 my-3 gap-3 justify-content-center">
                <select className="input2 bg-color col-8 col-md-4" style={{backgroundColor: "rgba(24,3,102,1)"}} onChange={(e)=>{
