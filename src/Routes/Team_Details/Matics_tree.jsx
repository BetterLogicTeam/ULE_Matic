...
import './tree.css'
import './Matics.css';
import default_image from '../../assets/tree/defaultnew.png'
import active_user from '../../assets/tree/user3green.png'
import inactive_user from '../../assets/tree/red-icon.png'
    ...
    return (
        <div className="row justify-content-center">
            ...
            <div className="col-md-11 py-3">
                <PagePath data={{ page_name: "Club Viewv", page_path: "Team Details / Club View" }} />
                <div className="col-12 row justify-content-center py-5">
                    <div className="col-md-6 col-10 gy-2 py-2 col-lg-4 row profile-border justify-content-center align-items-center profile-login">
                        ...
                        <select className="p-2 my-2 mx-3 profile-border bg-color col-10 col-md-10 col-lg-7" style={{color:'white'}} onChange={(e)=>{
                        ...
                        <button className="btn btn-success col-7 col-md-4 col-lg-3 col-xl-2 btn-succ" onClick={()=>{
                            referral_API()
                        }}>Submit</button>
                                                ...
                                                <div className="dropdown">
                                                    <button className="dropbtn">
                                                        ...
                                                        <img
                                                            ...
                                                            className="abc" style={{ margin: "0 80px", cursor: "pointer"}} width="50" height="25" onclick="Image_Click(364734)" />
                                                    </button>
                                                    ...
                                                    <div className="dropdown">
                                                        <button className="dropbtn">
                                                            <img src={userdata[1].package >= 1 ? active_user : userdata[1].package == 0 ? inactive_user : default_image}
                                                                onClick={() => (setIdnumer(userdata[1].id), addValue(userdata[1].id))} className="abc" style={{ margin: "0 25px", cursor: "pointer" }} width="50" height="25" onclick="Image_Click()" />
                                                        </button>
                                                        <div className="span" style={{ color: "#fff" }}>
                                                            {userdata[1]?.name}  <br />
                                                    ...
                                                    <div className="dropdown">
                                                        <button className="dropbtn">
                                                            ...
                                                            <img src={userdata[2].package >= 1 ? active_user : userdata[2].package == 0 ? inactive_user : default_image}
                                                                onClick={() => (setIdnumer(userdata[2].id), addValue(userdata[2].id))} className="abc" style={{ margin: "0 25px", cursor: "pointer" }} width="50" height="25" onclick="Image_Click()" />
                                                        </button>
                                                        <div className="span" style={{ color: "#fff" }}>
                                                            {userdata[2]?.name}  <br />
                                                    ...
                                                    <div className="dropdown">
                                                        <button className="dropbtn">
                                                            ...
                                                            <img src={userdata[3].package >= 1 ? active_user : userdata[3].package == 0 ? inactive_user : default_image}
                                                                onClick={() => (setIdnumer(userdata[3].id), addValue(userdata[3].id))} className="abc" width="50" height="25" onclick="Image_Click()" />
                                                        </button>
                                                        <div className="span" style={{ color: "#fff" }}>
                                                            {userdata[3]?.name}  <br />
                                                    ...
                                                    <div className="dropdown">
                                                        <button className="dropbtn">
                                                            ...
                                                            <img src={userdata[4].package >= 1 ? active_user : userdata[4].package == 0 ? inactive_user : default_image}
                                                                onClick={() => (setIdnumer(userdata[4].id), addValue(userdata[4].id))} className="abc" width="50" height="25" onclick="Image_Click()" />
                                                        </button>
                                                        <div className="span" style={{ color: "#fff" }}>
                                                            {userdata[4]?.name}  <br />
                                                    ...
                                                    <div className="dropdown">
                                                        <button className="dropbtn">
                                                            ...
                                                            <img src={userdata[5].package >= 1 ? active_user : userdata[5].package == 0 ? inactive_user : default_image}
                                                                onClick={() => (setIdnumer(userdata[5].id), addValue(userdata[5].id))} className="abc" width="50" height="25" onclick="Image_Click()" />
                                                        </button>
                                                    ...
                                                    <div className="dropdown">
                                                        <button className="dropbtn">
                                                            ...
                                                            <img src={userdata[6].package >= 1 ? active_user : userdata[6].package == 0 ? inactive_user : default_image}
                                                                onClick={() => (setIdnumer(userdata[6].id), addValue(userdata[6].id))} className="abc" width="50" height="25" onclick="Image_Click()" />
                                                        </button>
                                                        <div className="span" style={{ color: "#fff" }}>
                                                            {userdata[6]?.name}  <br />
