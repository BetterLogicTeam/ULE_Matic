    ...
    rows: [
      {
        sr: '1',
        id: '625029',
        Wallet: 'TNS5EsYNsnnnDQsGGkzaFmZWHfGtseLYTJzaFmZWHfGt',
        date_time: '6/20/2022 9:36:01 AM',
        remark: 'Active',
        activation_date: '12/11/2021 1:40:08 PM',
        staking: '200.00',
      },
      {
        sr: '2',
    ...
    <>
      <div className="" style={{ padding: '5px 30px 5px 30px' }}>
        <div className="row justify-content-center">
          <PagePath data={{ page_name: 'My Forum', page_path: 'Team Details / My Forum' }} />
          ...
          <div className="col-md-6 py-3 text-center" style={{ width: "50%"}}>
            <Table data={[...currentPost]} columns={My_Team.cols} />
          ...
          <div className="col-md-6 py-3 text-center"  style={{ width: "50%"}}>
            <Table data={[...currentPostRight]} columns={My_Team.cols} />
            ...
            <Table_Buttons
              ...
              totalData={referralApi_right.length}
